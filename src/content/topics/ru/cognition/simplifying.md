...
**Как работает:** Включает два компонента: тенденцию к срочности (быстрое достижение закрытия) и тенденцию к постоянству (длительное сохранение определённости). Приводит к принятию первой доступной информации и фиксированию на ней.
...
**Проблематичные аспекты:** Приводит к чрезмерной поляризации, затрудняет компромиссы и понимание сложных вопросов. Клинически связано с пограничным расстройством личности и авторитарными установками.
